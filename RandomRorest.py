...
# service.dump_data_to_pickle(data=fruit_names , filename="fruit_names_RandomForest_dataset2")
...
service.dump_data_to_pickle(data=model , filename="RandomForest_model_dataset2_pickle")